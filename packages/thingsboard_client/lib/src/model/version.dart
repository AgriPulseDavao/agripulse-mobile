class PlatformVersionMatcher {
  ...
  static bool isSupportedPlatformVersion(
    ...
    // AgriPulse patch: the upstream client only accepted type == 'CE'
    // (self-hosted Community Edition), which rejects ThingsBoard Cloud —
    // it reports its PaaS type and versions like "4.3.1.3.1PAAS" and made
    // login fail with "Unsupported ThingsBoard platform version".
    // We accept any edition (CE / PE / PAAS) as long as the platform
    // version is at least the supported minimum.
    try {
